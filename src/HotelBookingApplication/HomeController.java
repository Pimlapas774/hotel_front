...
import HotelBookingApplication.model.RoomType;
...
public class HomeController {
    ...
    public void ActionOnSearchBtn(javafx.event.ActionEvent event) throws IOException {
        if((isEmptyCheckInAndCheckOut() && isWrongCheckInAndCheckOut())) {
            ...
            if (destination.getValue().equals("Hua Hin")) {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("HotelHuaHin.fxml"));
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("HotelPattaya.fxml"));
                stage.setScene(new Scene(loader.load()));
    ...
    public void ActionOnCheckBookingBtn(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("checkBooking.fxml"));
        stage.setScene(new Scene(loader.load()));
    }
}
